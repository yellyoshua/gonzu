export const WelcomePhrase = () => {
  return (
    <div>
      <h1 className="font-jost font-bold text-xl text-darkPrimaryBold dark:text-darkTextBold">
        Padres, Madres de familia, representantes legales, estudiantes.
      </h1>
      ...
      <p className="font-jost mt-3 leading-relaxed font-normal text-lg text-darkPrimaryBold dark:text-darkTextParagraph">
        Somos una comunidad Educativa que busca la formación integral del
        estudiante. Sé parte de este gran proyecto educativo.
      </p>
    </div>
  );
};
