...
import { Tooltip, UniconIcon, SeparateLine } from "@/app/components/index";
...
export function Footer() {
  ...
  return (
    ...
    >
      ...
      <div className="py-3">
        <p
          className={`text-center text-black font-bold text-lg font-arvo uppercase antialiased`}
        >
          Redes sociales
        </p>
        <DownArrow
          className={`m-auto mt-10 mb-5 ${
            activeHover ? "text-black" : "text-gray-500"
          ...
          return (
            <Tooltip key={index} tooltip={social.name}>
              <a
                href={social.url}
                target="_blank"
                className="mx-1 text-center text-2xl p-2 rounded-sm hover:text-black transition-all text-gray-500"
              >
      ...
      <div className="py-5 text-center">
        <p className="italic select-none text-base font-arvo">
          "Primero en tu mente, luego en tu realidad"
        </p>
        <p className="text-center text-xs font-arvo">
      ...
      <div className="my-3 flex justify-center select-none">
        <Link href="/yellyoshua">
          <a className="font-arvo border-2 px-2 py-2 font-bold text-gray-500 border-gray-500 hover:border-purple-700 hover:text-purple-700">
            @yellyoshua
          </a>
        </Link>
      </div>
      ...
      <div className="my-2">
        <p className="text-center text-gray-500 text-xs font-arvo font-light">
          © {copyright}
        </p>
      </div>
    </footer>
